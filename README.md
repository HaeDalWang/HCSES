...
[TICKERS.md](TICKERS.md) 참조 — KR 11종목 + US 25종목 = 36종목, 편입 사유 및 종목 추가 방법.
...
ap-northeast-2 (서울) 기준, 현재 36종목 운영 시 예상 비용입니다.

| 서비스 | 산출 근거 | 월 예상 비용 |
|---|---|---|
| Lambda (DataCollector KR/US) | 2회/일 × 22일 × 512MB × 480초 | $0.44 |
...
| Lambda 요청 비용 | ~500회/월 × $0.20/1M | $0.00 |
| DynamoDB 쓰기 | ~2,500 WCU/월 × $1.4846/100만 WCU | $0.01 |
| DynamoDB 읽기 | ~40,000 RCU/월 × $0.2969/100만 RCU | $0.01 |
| DynamoDB 스토리지 | ~0.5GB × $0.2969/GB | $0.15 |
| EventBridge | ~500 이벤트/월 (무료 한도 내) | $0.00 |
| Secrets Manager | 1 시크릿 × $0.40 + ~20 API 호출 | $0.40 |
| CloudWatch Logs 수집 | ~400MB × $0.76/GB | $0.30 |
| CloudWatch Logs 보관 | ~1.2GB × $0.0314/GB (90일) | $0.04 |
| **합계** | | **~$2.21/월** |
